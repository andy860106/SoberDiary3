...
public class BreathDetail {
	...
	public BreathDetail(long timestamp, int blow_start_times,
			int blow_break_times, float pressure_diff_max, float pressure_min,
			float pressure_average, int voltage_init,
			long disconnection_millis, int serial_diff_max,
			float serial_diff_average, String sensorId) {
