...
import ubicomp.soberdiary3.main.ui.spinnergroup.MultiRadioGroup;
import ubicomp.soberdiary3.main.ui.spinnergroup.SingleRadioGroup;
...
public class SettingActivity extends Activity {
	...
	private void setting() {
		...
		RelativeLayout privacyView = createListView(R.string.setting_privacy,
				new OnClickListener() {
		...
		/*socialGroup = new MultiRadioGroup(activity, ConnectSocialInfo.NAME,
				socialSelected, 3, R.string.setting_limit,
				ClickLogId.SETTING_SELECT + SOCIAL);
		socialGroupView = socialGroup.getView();

		View socialView = createListView(R.string.setting_social,
				new OnClickListener() {
					private boolean visible = false;
