...
import ubicomp.soberdiary3.statistic.ui.questionnaire.content.Type2Content;
import ubicomp.soberdiary3.statistic.ui.questionnaire.content.Type3Content;
...
public class QuestionnaireDialog {
	...
	public QuestionnaireDialog(QuestionnaireDialogCaller quesDialogCaller,
		...
		boxLayout = (RelativeLayout) inflater.inflate(
				R.layout.dialog_statistic_questionnaire, null);
		boxLayout.setVisibility(View.INVISIBLE);

		questionLayout = (LinearLayout) boxLayout
				.findViewById(R.id.question_layout);
		questionParam = (LinearLayout.LayoutParams) questionLayout
				.getLayoutParams();
	...
	public void initialize() {
		...
		RelativeLayout.LayoutParams mainParam = (LayoutParams) boxLayout
				.getLayoutParams();
	...
	private int insertSequence() {
		int addScore = db.insertQuestionnaire(new Questionnaire(System
				.currentTimeMillis(), type, seqToString(), 0));
		return addScore;
	}
