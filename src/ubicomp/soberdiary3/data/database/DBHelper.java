...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE UserVoiceRecord ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				...
				+ " recordDay INTEGER NOT NULL," + " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL DEFAULT 0" + ")");

		db.execSQL("CREATE TABLE EmotionDIY ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " year INTEGER NOT NULL," + " month INTEGER NOT NULL,"
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " selection INTEGER NOT NULL," + " recreation CHAR[255],"
				+ " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL  DEFAULT 0" + ")");

		db.execSQL("CREATE TABLE EmotionManagement ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " year INTEGER NOT NULL," + " month INTEGER NOT NULL,"
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " recordYear INTEGER NOT NULL,"
				+ " recordMonth INTEGER NOT NULL,"
				+ " recordDay INTEGER NOT NULL," + " emotion INTEGER NOT NULL,"
				+ " type INTEGER NOT NULL," + " reason CHAR[255] NOT NULL,"
				+ " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL  DEFAULT 0" + ")");
		...
		db.execSQL("CREATE TABLE Questionnaire ("
				...
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " type INTEGER NOT NULL," + " sequence CHAR[255] NOT NULL,"
				+ " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL  DEFAULT 0" + ")");

		db.execSQL("CREATE TABLE StorytellingTest ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " year INTEGER NOT NULL," + " month INTEGER NOT NULL,"
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " questionPage INTEGER NOT NULL,"
		...
		db.execSQL("CREATE TABLE StorytellingRead ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " year INTEGER NOT NULL," + " month INTEGER NOT NULL,"
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " addedScore INTEGER NOT NULL DEFAULT 0,"
				+ " page INTEGER NOT NULL," + " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL DEFAULT 0" + ")");

		db.execSQL("CREATE TABLE GCMRead ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " ts INTEGER NOT NULL,"
		...
		db.execSQL("CREATE TABLE FacebookInfo ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " year INTEGER NOT NULL," + " month INTEGER NOT NULL,"
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " pageWeek INTEGER NOT NULL,"
				+ " pageLevel INTEGER NOT NULL," + " text CHAR[500] NOT NULL,"
				+ " addedScore INTEGER NOT NULL,"
				+ " uploadSuccess INTEGER NOT NULL,"
				+ " privacy INTEGER NOT NULL DEFAULT 0,"
				+ " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL DEFAULT 0" + ")");

		db.execSQL("CREATE TABLE AdditionalQuestionnaire ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ " year INTEGER NOT NULL," + " month INTEGER NOT NULL,"
				+ " day INTEGER NOT NULL," + " ts INTEGER NOT NULL,"
				+ " week INTEGER NOT NULL," + " timeSlot INTEGER NOT NULL,"
				+ " addedScore INTEGER NOT NULL DEFAULT 0,"
				+ " emotion INTEGER NOT NULL," + " craving INTEGER NOT NULL,"
				+ " score INTEGER NOT NULL,"
				+ " upload INTEGER NOT NULL DEFAULT 0" + ")");

		db.execSQL("CREATE TABLE UserVoiceFeedback ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
		...
		db.execSQL("CREATE TABLE BreathDetail ("
				+ " id INTEGER PRIMARY KEY AUTOINCREMENT,"
