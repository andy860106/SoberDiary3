package ubicomp.soberdiary3.test.ui;
...
public class TestQuestionDialog {
	...
	private int[] emotionResIds = { R.drawable.emotion_0, R.drawable.emotion_1,
			R.drawable.emotion_2, R.drawable.emotion_3, R.drawable.emotion_4 };
	private int[] cravingResIds = { R.drawable.craving_0, R.drawable.craving_1,
			R.drawable.craving_2, R.drawable.craving_3, R.drawable.craving_4,
			R.drawable.craving_5, R.drawable.craving_6, R.drawable.craving_7,
			R.drawable.craving_8, R.drawable.craving_9 };
	...
	private int highlight_color = App.getContext().getResources()
	...
	public TestQuestionDialog(
		...
		emotionStr = context.getResources().getStringArray(
				R.array.emotion_state);
		cravingStr = context.getResources().getStringArray(
				R.array.craving_state);
	...
	protected void setting() {
		...
		boxLayout = (RelativeLayout) inflater.inflate(
				R.layout.dialog_test_question, null);
		...
		gpsRadioGroup = (RadioGroup) boxLayout
				.findViewById(R.id.msg_gps_radiogroup);
		...
		emotionSeekBar = (SeekBar) boxLayout
				.findViewById(R.id.msg_emotion_seek_bar);
		cravingSeekBar = (SeekBar) boxLayout
				.findViewById(R.id.msg_craving_seek_bar);
		...
		emotionShowText = (TextView) boxLayout
				.findViewById(R.id.msg_emotion_show_text);
		emotionShowText.setTypeface(wordTypeface);

		cravingShowText = (TextView) boxLayout
				.findViewById(R.id.msg_craving_show_text);
	...
	private class EndOnTouchListener implements View.OnTouchListener {
		...
		private Rect rect;
		private final int normalSize = App.getContext().getResources()
				.getDimensionPixelSize(R.dimen.normal_title_size);
		private int largeSize = App.getContext().getResources()
				.getDimensionPixelSize(R.dimen.large_title_size);
