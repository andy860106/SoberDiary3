...
import ubicomp.soberdiary3.statistic.ui.questionnaire.content.CallCheckContent;
...
public class HotLineOnClickListener extends QuestionnaireOnClickListener {
	...
	public void onClick(View v) {
		...
		seq.add(5);
		String emotion_hot_line = msgBox.getContext().getString(
				R.string.call_check_help_emotion_hot_line);
		contentSeq.add(new CallCheckContent(msgBox, emotion_hot_line,
				"0800788995", true));
