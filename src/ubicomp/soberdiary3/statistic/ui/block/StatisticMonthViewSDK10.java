package ubicomp.soberdiary3.statistic.ui.block;
...
public class StatisticMonthViewSDK10 extends StatisticPageView {
	...
	public StatisticMonthViewSDK10() {
		...
		timeLayout = (LinearLayout) view
				.findViewById(R.id.statistic_month_timeblock_label_layout);
		blockLayout = (TableLayout) view
				.findViewById(R.id.statistic_month_block_layout);
	...
	public void load() {
		...
		int b_width = context.getResources().getDimensionPixelSize(
				R.dimen.month_line_width);
		int b_gap = context.getResources().getDimensionPixelSize(
				R.dimen.month_line_gap);
		for (int i = 0; i < nBlocks * nDays; ++i) {
			TableRow.LayoutParams cParam = (TableRow.LayoutParams) circles[i]
					.getLayoutParams();
