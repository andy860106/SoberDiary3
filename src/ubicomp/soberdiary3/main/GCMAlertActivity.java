...
public class GCMAlertActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView msg_title = (TextView) dialog
				.findViewById(R.id.gcm_alert_title);
	...
	protected void onPause() {
		...
		if (data != null) {
			DatabaseControl db = new DatabaseControl();
			db.readGCMRead(new GCMRead(data.getTv().getTimestamp(), System
					.currentTimeMillis(), data.getMessage(), true));
		}
		finish();
	}
}
