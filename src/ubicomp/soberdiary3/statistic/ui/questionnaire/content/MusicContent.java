...
import ubicomp.soberdiary3.statistic.ui.questionnaire.listener.MusicEndOnClickListener;
...
public class MusicContent extends QuestionnaireContent {
	...
	public MusicContent(QuestionnaireDialog msgBox, int aid) {
		super(msgBox);
		this.aid = aid;
		TEXT = msgBox.getContext().getResources()
				.getStringArray(R.array.question_solutions);
	}
	...
	protected void setContent() {
		...
		msgBox.setNextButton(TEXT[aid - AID_START_IDX],
				new MusicEndOnClickListener(msgBox));
